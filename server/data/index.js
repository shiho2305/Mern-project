...
export const posts = [
  {
    ...
    comments: [
      ...
      },
      {
        ...
        content: "Yet another random comment",
        createdAt: new Date(),
      },
    ],
  },
    ...
    comments: [
      {
        ...
        content: "One more random comment",
        createdAt: new Date(),
      },
      {
        userId: userIds[2].toString(),
        content: "And another random comment",
        createdAt: new Date(),
      },
      {
        userId: userIds[1].toString(),
        content: "No more random comments",
        createdAt: new Date(),
      },
      {
        userId: userIds[3].toString(),
        content: "I lied, one more random comment",
        createdAt: new Date(),
      },
    ],
  },
